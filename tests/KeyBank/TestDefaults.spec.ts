...
test.describe('Verify initial configuration',() => {
    ...
    test ('Default Data Verification of United Way Giving page portlets', async ({page})=>{
        ...
        await pm.useUWGivingPage().examinePortletTab("United Way Match Balance",Default_UWGivingData)
        await pm.useUWGivingPage().examinePortletTab("United Way Credit Card Transactions",Default_UWGivingData)
        await pm.useUWGivingPage().examinePortletTab("Payroll Contributions",Default_UWGivingData)
     })
